...
const ExciseHandler = require('./ExciseHandler')
const ManufacturerHandler = require('./ManufacturerHandler')
...
transactionProcessor.addHandler(new ExciseHandler())
transactionProcessor.addHandler(new ManufacturerHandler())
transactionProcessor.addHandler(new TransferHandler())
transactionProcessor.addHandler(new SalesHandler())
